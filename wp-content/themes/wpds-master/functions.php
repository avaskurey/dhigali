...
//***********************
	if( !function_exists('base_extended_editor_mce_buttons') ){
		function base_extended_editor_mce_buttons($buttons) {
			...
			return array(
				'wp_adv','italic', 'bold','justifyleft', 'justifycenter', 'charmap', 'removeformat'
			);
			/* WordPress Default
			return array(
	...
	echo 'Powered by <a href="http://www.wordpress.org" target="_blank">Binary Solutions</a> &nbsp;&#x272D;&nbsp; Built by <a href="http://binarysolutions.mv/">@burakinaru</a></p>';
	}
